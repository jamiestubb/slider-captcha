(function () {
    ...
    _proto.initImg = function () {
        ...
        img.onerror = function () {
            ...
            if (window.location.protocol === 'file:') {
                ...
                console.error("Can't load image from file:// protocol. Try http or https instead.");
            }
        ...
        img.setSrc = function () {
            ...
            if (isIE) {
                ...
                xhr.onloadend = function (e) {
                    var file = new FileReader(); // IE10+ only
    ...
    _proto.bindEvents = function () {
        ...
        var handleDragEnd = function (e) {
            ...
            that.trail = trail; // store the movement in 'that.trail'
    ...
    _proto.verify = function () {
        var arr = this.trail; // y-axis movement
